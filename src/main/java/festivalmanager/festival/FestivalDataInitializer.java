...
public class FestivalDataInitializer implements DataInitializer {
    ...
    public void initialize() {
        ...
        List.of(new Festival("Weihnachtsfestival", locationManagement.findAllByName("Arteum").toList().get(0),
                "2021-12-24", "2021-12-31", "Weihnachtsfestival Beschreibnung"),
                new Festival("Maifeld Derby 2021", locationManagement.findAllByName("Mannheim").toList().get(0),
                        "2021-09-03", "2021-09-05",
                        "Maifeld Derby ist ein Indie, Rock, Pop und Electronic Festival, das vom 03.09.2021 bis 05.09.2021 in Mannheim (DE) stattgefunden hat. Das Festival wurde von ca. 5.000 Fans besucht. Tickets kosteten EUR 80,00. Die Top-Acts waren Drangsal, Sophie Hunger und The Notwist. Darüber hinaus waren Dives, Molchat Doma, Feng Suave, Culk, Cari Cari, Dÿse und viele mehr gebucht."))
